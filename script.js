document.addEventListener("DOMContentLoaded",
    ...
    let profile_pic = document.querySelector("#profile_pic img.circle_pic")
    ...
    profileEditButton.addEventListener("mouseover", function() {
        profileEditButton.style.border = "2px solid royalblue";
    });
    
    profileEditButton.addEventListener("mouseleave", function() {
        profileEditButton.style.border = "2px solid gray";
    });
    }
